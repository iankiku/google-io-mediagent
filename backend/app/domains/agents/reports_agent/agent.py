...
_PIPELINE_PATH = Path(__file__).with_name("reports_pipeline.py")
_MODULE_NAME = "reports_pipeline_module"
...
def _load_pipeline_module() -> ModuleType:
    ...
    if spec is None or spec.loader is None:
        raise ImportError(f"Could not load reports_pipeline.py from {_PIPELINE_PATH}")
...
def main() -> None:
    ...
    print(run_reports_agent(query, user_id=user_id))
