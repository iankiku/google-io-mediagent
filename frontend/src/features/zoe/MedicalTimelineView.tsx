      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            {entry.isSummary && (
              <span className="inline-flex items-center h-6 px-2.5 rounded-full bg-[color:var(--zoe-lilac-soft)] text-[color:var(--zoe-lilac)] text-[10px] font-bold uppercase tracking-wider">
        ...
        {entry.isSummary && (
          <div className="mt-4 rounded-xl bg-muted/60 ring-1 ring-foreground/5 px-3.5 py-2.5 flex items-start gap-2">
            ...
            <p className="text-[12px] text-muted-foreground leading-snug">
              This summary is generated by Zoe AI to help you understand your clinical
